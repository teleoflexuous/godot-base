class_name CameraInputMapAdapter
extends CameraInputAdapter

const INPUT_MAP_DEFAULTS: Script = preload("res://addons/camera_rigs/runtime/input/camera_input_map_defaults.gd")

@export var actions: CameraInputMapActions = CameraInputMapActions.new()
