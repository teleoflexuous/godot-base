...
@export var preferences: CameraUserPreferences = CameraUserPreferences.new()
...
func set_preferences(next_preferences: CameraUserPreferences) -> void:
	preferences = next_preferences if next_preferences != null else CameraUserPreferences.new()
