class_name CameraInputMapDefaults
extends RefCounted
...
static func ensure_missing_actions(actions: CameraInputMapActions = null) -> void:
	var surface: CameraInputMapActions = actions if actions != null else CameraInputMapActions.new()
