class_name CameraPreset3D
extends Resource

@export_category("Follow")
@export var follow_enabled: bool = true
@export var follow_interruption: CameraRigTypes.FollowInterruption = CameraRigTypes.FollowInterruption.OFFSET_WHILE_FOLLOWING
...
@export var zoom_mechanism: CameraRigTypes.ZoomMechanism3D = CameraRigTypes.ZoomMechanism3D.DOLLY
@export var zoom_anchor: CameraRigTypes.ZoomAnchor = CameraRigTypes.ZoomAnchor.FOLLOW_TARGET
...
@export var pitch_policy: CameraRigTypes.PitchPolicy = CameraRigTypes.PitchPolicy.FIXED
...
@export var view_policy: CameraRigTypes.ViewPolicy3D = CameraRigTypes.ViewPolicy3D.THIRD_PERSON_ONLY
...
@export var occlusion_mode: CameraRigTypes.OcclusionMode = CameraRigTypes.OcclusionMode.PULL_IN
