class_name CameraPreset2D
extends Resource

@export_category("Follow")
@export var follow_enabled: bool = false
@export var follow_interruption: CameraRigTypes.FollowInterruption = CameraRigTypes.FollowInterruption.BREAK_ON_PAN
...
@export var zoom_anchor: CameraRigTypes.ZoomAnchor = CameraRigTypes.ZoomAnchor.POINTER_WORLD_HIT
