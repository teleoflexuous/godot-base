...
const EXAMPLES: Array[Dictionary] = [
	{"name": "2D management", "path": "res://addons/camera_rigs/examples/2d_management.tscn"},
	{"name": "2D platformer", "path": "res://addons/camera_rigs/examples/2d_platformer.tscn"},
	{"name": "3D character", "path": "res://addons/camera_rigs/examples/3d_character.tscn"},
	{"name": "3D management", "path": "res://addons/camera_rigs/examples/3d_management.tscn"},
	{"name": "3D RTS / MOBA", "path": "res://addons/camera_rigs/examples/3d_rts_moba.tscn"},
]
