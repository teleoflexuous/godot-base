...
@export var rig_path: NodePath = ^"CameraRig2D"
@export var adapter_path: NodePath = ^"CameraInputMapAdapter"
@export var target_path: NodePath
@export var platformer_mode: bool = false
@export var title: String = "2D Camera"
@export_file("*.tscn") var gallery_scene_path: String = "res://addons/camera_rigs/examples/camera_gallery.tscn"

var _rig: CameraRig2D
var _target: Node2D


func _ready() -> void:
	_rig = get_node_or_null(rig_path) as CameraRig2D
	var adapter: CameraInputMapAdapter = get_node_or_null(adapter_path) as CameraInputMapAdapter
	if adapter != null:
