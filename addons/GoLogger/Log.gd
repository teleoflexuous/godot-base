...
func get_value(value : String) -> Variant:
	...
	var defaults := {
		"plugin/base_directory": "user://GoLogger/",
		"plugin/categories": [["game", 0, "null", "null", 0, 0, false], ["player", 1, "null", "null", 0, 0, false]],
		"settings/columns": 6,
		"settings/log_header": 0,
		"settings/canvaslayer_layer": 5,
		"settings/autostart_session": true,
		"settings/timestamp_entries": true,
		"settings/use_utc": false,
		"settings/dash_separator": false,
		"settings/limit_method": 0,
		"settings/entry_count_action": 0,
		"settings/session_timer_action": 0,
		"settings/file_cap": 10,
		"settings/entry_cap": 300,
		"settings/session_duration": 300.0,
		"settings/error_reporting": 0,
		"settings/disable_warn1": false,
		"settings/disable_warn2": false,
	}
	
	if !FileAccess.file_exists(PATH):
		push_warning(str("GoLogger: No settings.ini file present in ", PATH, ". Generating a new file with default settings."))
		create_settings_file()
		_result = _config.load(PATH)
	...
	var key_path := "%s/%s" % [section, value]
	var _val = _config.get_value(section, value, defaults.get(key_path, null))
	if _val == null:
